  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property="og:title"
          content="Quick Car Auto Spare Parts Order Online in Dubai, UAE | Emirates-car.com"
        />
      ...
      <div className="w-3/4 mx-auto">
        <div>
          <h1 className="text-blue-600 text-4xl md:text-lg lg:text-2xl font-extrabold xs:text-base 2xs:text-xs">
            Honda Car Parts in Dubai Online for German, American, Japan, Korean
            and more models
          </h1>
          <Link
      ...
      <div className="grid grid-cols-1 place-content-center pt-10 xs:pt-5 mx-8">
        <div>
          ...
          <p className="text-xl font-mono text-gray-700 mx-auto">
            ...
            parts are in scarce in Dubai, UAE and its difficult to find its
          ...
          <h3
            className="text-4xl font-extrabold mx-auto my-5"
            id="oemvsaftermarket"
          >
          ...
          <p className="text-xl font-mono text-gray-700 mx-auto font-extrabold xl:mx-10 lg:mx-10 md:mx-10 sm:mx-5 xs:mx-2 xs:py-0 2xs:mx-2 s:mx-2  md:ml-11 my-10">
            Availability of Honda parts in Dubai:
          </p>
          ...
          <p className="text-4xl font-extrabold mx-auto my-5">
            List of Genuine and Aftermarket Honda spare parts in Dubai , UAE
          </p>
          ...
          <div className="grid grid-cols-1 place-content-center">
            <p className="text-4xl font-extrabold font-mono mx-auto my-5">
          ...
          <div className="py-5">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d462562.65102636546!2d54.94754444558808!3d25.075759435668097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xbde66e5084295162!2sDubai%20-%20United%20Arab%20Emirates!5e0!3m2!1sen!2sin!4v1640016582896!5m2!1sen!2sin"
              height={300}
              width="100%"
