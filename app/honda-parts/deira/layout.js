...
export const metadata = {
         ...
         description:
           'Buy Car Parts - Used, Genuine, OEM (Original parts) and Aftermarket Honda spare parts from Dubai Dealer in Deira',
         openGraph: {
           images: '/favicon.png',
           title:
             'Honda Car spare Parts in Deira from Dubai dealers Online |Emirates-car.com',
           description:
             'Buy Car Parts - Used, Genuine, OEM (Original parts) and Aftermarket Honda spare parts from Dubai Dealer in deira',
           url: 'https://www.emirates-car.com/honda-parts/deira',
         ...
         twitter: {
           ...
           title:
             'Honda Car Parts in Deira from Dubai dealers Online | Emirates-car.com',
           url: 'https://www.emirates-car.com/honda-parts/deira',
           description:
             'Buy Car Parts - Used, Genuine, OEM (Original parts) and Aftermarket Honda spare parts from Dubai Dealer in deira',
         ...
         category: 'car parts',
         alternates: {
           canonical: 'https://emirates-car.com/honda-parts/deira'
         },
         keywords:
