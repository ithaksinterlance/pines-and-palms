...
export const metadata = {
         title:
           'Honda Car Parts in Mussafah, Abu Dhabi from Dubai dealers Online | Emirates-car.com',
         description:
           'Buy Car Parts - Used, Genuine, OEM (Original parts) and Aftermarket Honda spare parts from Dubai Dealer',
         openGraph: {
           images: '/favicon.png',
           title:
             'Honda Car Parts in Mussafah, Abu Dhabi from Dubai dealers Online | Emirates-car.com',
           description:
             'Buy Car Parts - Used, Genuine, OEM (Original parts) and Aftermarket Honda spare parts from Dubai Dealer',
           url: 'https://emirates-car.com/honda-parts/abu-dhabi',
