...
export const metadata = {
  ...
  description:
    'Used, Genuine, Aftermarket, OEM Honda Accord Auto parts Online delivered in Ajman'
};
    ...
    <div>
      <Head>
        ...
        <meta
          name="description"
          content={
            'Used, Genuine / OEM, Aftermarket auto car spare parts Online for HONDA and other brands'
          }
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="Honda Car Parts in Ajman from Dubai dealers Online |
          Emirates-car.com"
        />
      ...
      <div className="grid grid-cols-1 place-content-center pt-10 xs:pt-5 mx-8">
        <div>
          ...
          <p className="text-xl font-mono text-gray-700 mx-auto font-extrabold xl:mx-10 lg:mx-10 md:mx-10 sm:mx-5 xs:mx-2 xs:py-0 2xs:mx-2 s:mx-2  md:ml-11 my-10">
            Availability of Honda parts in Ajman:
          </p>
          ...
          <div className="py-5">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d465132.6090253298!2d54.27841778442708!3d24.38657289151084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e440f723ef2b9%3A0xc7cc2e9341971108!2sAbu%20Dhabi%20-%20United%20Arab%20Emirates!5e0!3m2!1sen!2sin!4v1640018687052!5m2!1sen!2sin"
              height={300}
              width="100%"
