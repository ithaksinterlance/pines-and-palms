          ...
          <div className="grid grid-cols-3 xs:grid-cols-1 place-content-center">
            <div>
              ...
              <ol className="list-disc text-xl font-mono text-gray-700 mx-auto">
                ...
                <li>
                  <Link href="https://emirates-car.com/search-by-part-name/Cylinder%20Block" className="font-mono font-semibold text-blue-600 underline hover:text-blue-900">
                    Cylinder Block
                  </Link>
                </li>
                <li>
