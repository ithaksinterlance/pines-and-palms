...
export default function Terms() {
  return (
    <div className="mx-10 xs:mx-2 s:mx-2 md:mx-5 sm:mx-5">
      ...
      <p>Welcome to Quick Auto Spare Parts Hunt in UAE!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of IT.HAKSINTERLANCE's Website, located at https://emirates-car.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Quick Auto Spare Parts Hunt in UAE if
      ...
      <p>
        Unless otherwise stated, IT.HAKSINTERLANCE and/or its licensors own the
        intellectual property rights for all material on Quick Auto Spare Parts
        Hunt in UAE. All intellectual property rights are reserved. You may
        access this from Quick Auto Spare Parts Hunt in UAE for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Quick Auto Spare Parts Hunt in UAE</li>
        <li>
          Sell, rent or sub-license material from Quick Auto Spare Parts Hunt in
          UAE
        </li>
        <li>
          Reproduce, duplicate or copy material from Quick Auto Spare Parts Hunt
          in UAE
        </li>
        <li>Redistribute content from Quick Auto Spare Parts Hunt in UAE</li>
      </ul>
      ...
      <p>
        ...
        IT.HAKSINTERLANCE does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of IT.HAKSINTERLANCE,its agents and/or affiliates.
        ...
        IT.HAKSINTERLANCE shall not be liable for the Comments or for any
      ...
      <p>
        IT.HAKSINTERLANCE reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant IT.HAKSINTERLANCE a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of IT.HAKSINTERLANCE; and (d) the
      ...
      <p>
        ...
        e-mail to IT.HAKSINTERLANCE. Please include your name, your organization
      ...
      <p>
        No use of IT.HAKSINTERLANCE's logo or other artwork will be allowed for
