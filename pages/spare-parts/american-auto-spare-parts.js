...
export default function America({ partsposts, posts }) {
  ...
  return (
    <div>
      <Head>
        <title>
          Online American Auto Spare Parts in UAE - New | Used | Genuine |
          Aftermarket | OEM
        </title>
        ...
        <meta
          name="description"
          content={
            'Buy Online and Get delivered American Used, New, Genuine / Original / OEM, Aftermarket auto spare parts Online in uae'
          }
        />
        <meta
          property="og:title"
          content="Online American Auto Spare Parts in UAE - New | Used | Genuine | Aftermarket | OEM"
        />
        <meta
          name="keywords"
          content="american spare parts uae, american auto parts, american car parts"
        />
        <meta property="og:site_name" content="Emirates-car" />
        <meta
          property="og:url"
          content="https://www.emirates-car.com/country-vehicles-spare-parts/american-auto-spare-parts"
        />
        <meta
