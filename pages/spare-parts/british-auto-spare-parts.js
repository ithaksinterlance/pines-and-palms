    ...
    <div>
      <Head>
        ...
        <meta
          ...
          content="Explore from our immensively large-scale auto spare part website, your New / Used / Genuine / Aftermarket auto spare parts for your Vehicle needs - Car / Jeep / Van / Truck / Buses in Your city in UAE especially in the main cities like Dubai, Sharjah, Abu dhabi, Ajman and other city."
        />
        <meta
          ...
          <div>
            ...
            <h1 className="place-content-center grid grid-cols-1 xs:grid-cols-1 xs:grid s:grid s:grid-cols-1 text-base text-gray-500 xs:text-sm md:text-base p-5 mx-10 my-10">
              ...
              <ul className="list-disc">
                ...
                <li>Used Britain vehicle auto spare parts</li>
                <li>Genuine Britain vehicle auto spare parts</li>
                <li>Aftermarket Britain vehicle auto spare parts</li>
              </ul>
            </h1>
          </div>
        </div>
