  ...
  render() {
    return (
      <div className="d-flex justify-center text-center pt-10 xs:pt-5 mx-8">
        <h3 className="text-black text-4xl md:text-lg lg:text-2xl font-extrabold xs:text-base 2xs:text-xs">
          FEATURED PARTS
        </h3>
        <div className="grid grid-cols-6 xs:grid xs:grid-cols-1 s:grid s:grid-cols-1 2xs:grid 2xs:grid-cols-2 sm:grid sm:grid-cols-3 md:grid md:grid-cols-3 gap-1 shadow-2xl my-10 mx-5 xs:mx-3 s:mx-2 sm:mx-4 2xs:mx-4">
          <AutoPartsImages />
          <Link href="https://emirates-car.com/search-by-part-name" legacyBehavior>
            <main className="border-4 p-1 py-5 px-5 border-blue-700">
              ...
              <p className="text-xs text-gray-500">
                We deal with almost any auto spare parts in UAE. In case if you
                dont find your desired parts, you can contact us directly.
              </p>
            </main>
          </Link>
        </div>
