    ...
    return (
      <div className="mx-10 xs:mx-2 s:mx-2 md:mx-5 sm:mx-5">
        ...
        <p>
          ...
          use of IT.HAKSINTERLANCE's Website, located at
          https://emirates-car.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Quick Auto Spare Parts Hunt in UAE
        ...
        <p>
          Unless otherwise stated, IT.HAKSINTERLANCE and/or its licensors own
          the intellectual property rights for all material on Quick Auto Spare
          Parts Hunt in UAE. All intellectual property rights are reserved. You
          may access this from Quick Auto Spare Parts Hunt in UAE for your own
        ...
        <ul>
          ...
          <li>
            Sell, rent or sub-license material from Quick Auto Spare Parts Hunt
            in UAE
          </li>
          <li>
            Reproduce, duplicate or copy material from Quick Auto Spare Parts
            Hunt in UAE
          </li>
        ...
        <p>
          ...
          the hyperlink compensates the absence of IT.HAKSINTERLANCE; and (d)
        ...
        <p>
          ...
          sending an e-mail to IT.HAKSINTERLANCE. Please include your name, your
        ...
        <p>
          No use of IT.HAKSINTERLANCE's logo or other artwork will be allowed
