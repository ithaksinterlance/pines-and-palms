        ...
        <div className="w-3/4 2xs:w-full xs:w-full sm:w-full">
          <main className="mx-10 xs:mx-4 2xs:mx-4 sm:mx-4 md:mx-5 mt-10 border border-gray-100 shadow-sm my-10">
            ...
            <nobr className="text-blue-400 no-underline"><i className="fal fa-car-garage"></i> Current path:&nbsp;&nbsp;</nobr>
              ...
              <div className="grid grid-cols-2 xs:grid xs:grid-cols-1 sm:grid sm:grid-cols-1 s:grid s:grid-cols-1">
                <p className="text-base font-medium text-gray-500 p-5">
                  ...
                  order to keep the company into their targetted level.
                ...
                >
                  ...
                  <div className="flex flex-wrap -mx-3">
                    <div className="w-full px-3 mb-6 xs:mb-0 pb-3">
                      <label
                        className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 xs:mt-3"
                        htmlFor="partname"
                      >
